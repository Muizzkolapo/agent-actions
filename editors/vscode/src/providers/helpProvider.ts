        ...
        return [
            ...
            new HelpItemNode(
                ...
                new vscode.ThemeIcon('comment-discussion'),
                {
                    command: 'vscode.open',
                    title: 'Get Support',
                    arguments: [vscode.Uri.parse('https://github.com/qanalabs/agent-actions/discussions')],
                },
            ),
            new HelpItemNode(
                'Report a Bug',
                new vscode.ThemeIcon('bug'),
                {
                    command: 'vscode.open',
                    title: 'Report a Bug',
                    arguments: [vscode.Uri.parse('https://github.com/qanalabs/agent-actions/issues/new')],
                },
            ),
            new HelpItemNode(
                'Show Output Logs',
