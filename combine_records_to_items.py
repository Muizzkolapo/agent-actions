...
def create_new_clusters(cluster_validation_result):
    """
    ...
    """
    print(cluster_validation_result)
    ...
    urls = cluster_validation_result.get("url") or cluster_validation_result.get("content", {}).get("url", [])
