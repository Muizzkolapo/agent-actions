...
`analyze_clause` also carries an expectation. If the LLM returns null values for `risk_score` or other required fields, the block fails and the framework regenerates automatically:
