...
`score_quality` also carries an expectation. If the LLM returns null scores or missing fields, the block fails and the framework regenerates automatically:
