...
`generate_description` and `write_marketing_copy` also carry expectations. If the LLM returns null fields or incomplete structured output, the block fails and the framework regenerates automatically:
