...
DIRECTORY_STRUCTURE = [
    ...
    "input/preprocessing/processing",
    "input/context",
    "output",
    "output/response",
    "llm",
...
FILE_MIGRATIONS = {
    ...
    "preprocessing/parsing/operator_registry/base.py": "input/preprocessing/parsing/operator_registry/base.py",
    "preprocessing/parsing/operator_registry/comparison.py": "input/preprocessing/parsing/operator_registry/comparison.py",
    "preprocessing/parsing/operator_registry/logical.py": "input/preprocessing/parsing/operator_registry/logical.py",
    "preprocessing/parsing/operator_registry/functions.py": "input/preprocessing/parsing/operator_registry/functions.py",
    ...
    "preprocessing/field_resolution/reference_parser.py": "input/preprocessing/field_resolution/reference_parser.py",
    "preprocessing/field_resolution/schema_field_validator.py": "input/preprocessing/field_resolution/schema_field_validator.py",
    "preprocessing/field_resolution/exceptions.py": "input/preprocessing/field_resolution/exceptions.py",
    ...
    "preprocessing/transformation/string_transformer.py": "input/preprocessing/transformation/string_transformer.py",
    ...
    "preprocessing/processing/data_processor.py": "input/preprocessing/processing/data_processor.py",
    ...
    "preprocessing/context/context_preprocessor.py": "input/context/context_preprocessor.py",
    ...
    # LLM DOMAIN
    # ============================================================
    "llm_invocation/providers/client_base.py": "llm/providers/client_base.py",
    "llm_invocation/providers/batch_client_base.py": "llm/providers/batch_base.py",
    "llm_invocation/providers/batch_client_factory.py": "llm/providers/batch_client_factory.py",
    ...
    "llm_invocation/providers/tools/client.py": "llm/providers/tools/client.py",
    "llm_invocation/providers/tools/__init__.py": "llm/providers/tools/__init__.py",
    ...
    "llm_invocation/providers/openai/batch_client.py": "llm/providers/openai/batch_client.py",
    ...
    "llm_invocation/providers/gemini/batch_client.py": "llm/providers/gemini/batch_client.py",
    ...
    "llm_invocation/providers/groq/batch_client.py": "llm/providers/groq/batch_client.py",
    ...
    "llm_invocation/providers/mistral/batch_client.py": "llm/providers/mistral/batch_client.py",
    ...
    "llm_invocation/batch/processing/batch_passthrough_builder.py": "llm/batch/processing/batch_passthrough_builder.py",
    "llm_invocation/batch/processing/__init__.py": "llm/batch/processing/__init__.py",
    "llm_invocation/batch/core/batch_constants.py": "llm/batch/core/batch_constants.py",
    "llm_invocation/batch/core/batch_context_metadata.py": "llm/batch/core/batch_context_metadata.py",
    "llm_invocation/batch/core/batch_models.py": "llm/batch/core/batch_models.py",
    "llm_invocation/batch/core/__init__.py": "llm/batch/core/__init__.py",
    ...
    "llm_invocation/batch/infrastructure/batch_client_resolver.py": "llm/batch/infrastructure/batch_client_resolver.py",
    "llm_invocation/batch/infrastructure/batch_data_loader.py": "llm/batch/infrastructure/batch_data_loader.py",
    "llm_invocation/batch/infrastructure/batch_source_handler.py": "llm/batch/infrastructure/batch_source_handler.py",
    "llm_invocation/batch/infrastructure/__init__.py": "llm/batch/infrastructure/__init__.py",
    "llm_invocation/batch/batch_cli.py": "llm/batch/batch_cli.py",
    ...
    # Config
    "llm_invocation/config/vendor_config.py": "llm/config/vendor.py",
    # ============================================================
    ...
    "orchestration/version_correlator.py": "workflow/managers/loop.py",
    ...
    "cli/list_udfs.py": "cli/commands/list_udfs.py",
    ...
    "cli/schema.py": "cli/commands/schema.py",
    "cli/skills.py": "cli/commands/skills.py",
    "cli/test.py": "cli/commands/clean.py",
...
IMPORT_REWRITES = {
    ...
    "agent_actions.orchestration.version_correlator": "agent_actions.workflow.managers.loop",
    ...
    "agent_actions.preprocessing.parsing.operator_registry.base": "agent_actions.input.preprocessing.parsing.operator_registry.base",
    "agent_actions.preprocessing.parsing.operator_registry.comparison": "agent_actions.input.preprocessing.parsing.operator_registry.comparison",
    "agent_actions.preprocessing.parsing.operator_registry.logical": "agent_actions.input.preprocessing.parsing.operator_registry.logical",
    "agent_actions.preprocessing.parsing.operator_registry.functions": "agent_actions.input.preprocessing.parsing.operator_registry.functions",
    "agent_actions.preprocessing.field_resolution": "agent_actions.input.preprocessing.field_resolution",
    "agent_actions.preprocessing.field_resolution.reference_parser": "agent_actions.input.preprocessing.field_resolution.reference_parser",
    "agent_actions.preprocessing.field_resolution.schema_field_validator": "agent_actions.input.preprocessing.field_resolution.schema_field_validator",
    "agent_actions.preprocessing.field_resolution.exceptions": "agent_actions.input.preprocessing.field_resolution.exceptions",
    "agent_actions.preprocessing.transformation.data_transformer": "agent_actions.input.preprocessing.transformation.transformer",
    "agent_actions.preprocessing.transformation.string_transformer": "agent_actions.input.preprocessing.transformation.string_transformer",
    ...
    "agent_actions.preprocessing.processing.data_processor": "agent_actions.input.preprocessing.processing.data_processor",
    ...
    "agent_actions.preprocessing.context.historical_node_loader": "agent_actions.input.context.historical",
    "agent_actions.preprocessing.context.context_scope_normalizer": "agent_actions.input.context.normalizer",
    "agent_actions.preprocessing.context.context_preprocessor": "agent_actions.input.context.context_preprocessor",
    ...
    "agent_actions.response_processing.action_expander": "agent_actions.output.response.expander",
    "agent_actions.response_processing.schema_change": "agent_actions.output.response.schema",
    "agent_actions.response_processing.config_field_definitions": "agent_actions.output.response.config_fields",
    "agent_actions.preprocessing.filtering.filter_service": "agent_actions.input.preprocessing.filtering.service",
    # LLM invocation -> LLM
    "agent_actions.llm_invocation.providers": "agent_actions.llm.providers",
    "agent_actions.llm_invocation.providers.client_base": "agent_actions.llm.providers.client_base",
    "agent_actions.llm_invocation.providers.batch_client_factory": "agent_actions.llm.providers.batch_client_factory",
    "agent_actions.llm_invocation.providers.openai.batch_client": "agent_actions.llm.providers.openai.batch_client",
    "agent_actions.llm_invocation.providers.gemini.batch_client": "agent_actions.llm.providers.gemini.batch_client",
    "agent_actions.llm_invocation.providers.groq.batch_client": "agent_actions.llm.providers.groq.batch_client",
    "agent_actions.llm_invocation.providers.mistral.batch_client": "agent_actions.llm.providers.mistral.batch_client",
    "agent_actions.llm_invocation.providers.tools.client": "agent_actions.llm.providers.tools.client",
    "agent_actions.llm_invocation.batch": "agent_actions.llm.batch",
    "agent_actions.llm_invocation.batch.infrastructure.batch_client_resolver": "agent_actions.llm.batch.infrastructure.batch_client_resolver",
    "agent_actions.llm_invocation.batch.infrastructure.batch_data_loader": "agent_actions.llm.batch.infrastructure.batch_data_loader",
    "agent_actions.llm_invocation.batch.infrastructure.batch_source_handler": "agent_actions.llm.batch.infrastructure.batch_source_handler",
    "agent_actions.llm_invocation.batch.infrastructure.batch_registry_manager": "agent_actions.llm.batch.infrastructure.registry",
    "agent_actions.llm_invocation.batch.infrastructure.batch_context_manager": "agent_actions.llm.batch.infrastructure.context",
    "agent_actions.llm_invocation.batch.infrastructure.batch_job_manager": "agent_actions.llm.batch.infrastructure.job_manager",
    "agent_actions.llm_invocation.batch.processing.batch_passthrough_builder": "agent_actions.llm.batch.processing.batch_passthrough_builder",
    "agent_actions.llm_invocation.batch.core.batch_constants": "agent_actions.llm.batch.core.batch_constants",
    "agent_actions.llm_invocation.batch.core.batch_context_metadata": "agent_actions.llm.batch.core.batch_context_metadata",
    "agent_actions.llm_invocation.batch.core.batch_models": "agent_actions.llm.batch.core.batch_models",
    "agent_actions.llm_invocation.batch.core": "agent_actions.llm.batch.core",
    "agent_actions.llm_invocation.batch.batch_cli": "agent_actions.llm.batch.batch_cli",
    "agent_actions.llm_invocation.config.vendor_config": "agent_actions.llm.config.vendor",
