...
FILE_MIGRATIONS = {
    ...
    "input_loading/loaders.source_data.py": "input/loaders/source_data.py",
...
IMPORT_REWRITES = {
    ...
    "agent_actions.preprocessing.filtering.service": "agent_actions.input.preprocessing.filtering.service",
    # LLM invocation -> LLM
    "agent_actions.llm.providers": "agent_actions.llm.providers",
    "agent_actions.llm.providers.client_base": "agent_actions.llm.providers.client_base",
    "agent_actions.llm.providers.batch_client_factory": "agent_actions.llm.providers.batch_client_factory",
    "agent_actions.llm.providers.openai.batch_client": "agent_actions.llm.providers.openai.batch_client",
    "agent_actions.llm.providers.gemini.batch_client": "agent_actions.llm.providers.gemini.batch_client",
    "agent_actions.llm.providers.groq.batch_client": "agent_actions.llm.providers.groq.batch_client",
    "agent_actions.llm.providers.mistral.batch_client": "agent_actions.llm.providers.mistral.batch_client",
    "agent_actions.llm.providers.tools.client": "agent_actions.llm.providers.tools.client",
    "agent_actions.llm.batch": "agent_actions.llm.batch",
    "agent_actions.llm.batch.infrastructure.batch_client_resolver": "agent_actions.llm.batch.infrastructure.batch_client_resolver",
    "agent_actions.llm.batch.infrastructure.batch_data_loader": "agent_actions.llm.batch.infrastructure.batch_data_loader",
    "agent_actions.llm.batch.infrastructure.batch_source_handler": "agent_actions.llm.batch.infrastructure.batch_source_handler",
    "agent_actions.llm.batch.infrastructure.registry": "agent_actions.llm.batch.infrastructure.registry",
    "agent_actions.llm.batch.infrastructure.context": "agent_actions.llm.batch.infrastructure.context",
    "agent_actions.llm.batch.infrastructure.job_manager": "agent_actions.llm.batch.infrastructure.job_manager",
    "agent_actions.llm.batch.processing.batch_passthrough_builder": "agent_actions.llm.batch.processing.batch_passthrough_builder",
    "agent_actions.llm.batch.core.batch_constants": "agent_actions.llm.batch.core.batch_constants",
    "agent_actions.llm.batch.core.batch_context_metadata": "agent_actions.llm.batch.core.batch_context_metadata",
    "agent_actions.llm.batch.core.batch_models": "agent_actions.llm.batch.core.batch_models",
    "agent_actions.llm.batch.core": "agent_actions.llm.batch.core",
    "agent_actions.llm.batch.batch_cli": "agent_actions.llm.batch.batch_cli",
    "agent_actions.llm.config.vendor_config": "agent_actions.llm.config.vendor",
    "agent_actions.llm.realtime": "agent_actions.llm.realtime",
    "agent_actions.llm": "agent_actions.llm",
