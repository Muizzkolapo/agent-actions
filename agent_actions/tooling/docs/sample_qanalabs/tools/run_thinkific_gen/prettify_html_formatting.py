...
def prettify_html_formatting(quiz_obj: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if 'options' in formatted and isinstance(formatted['options'], list):
        formatted['options'] = [
            prettify_html(opt) if isinstance(opt, str) else opt
    ...
    if 'feynman_explanation_collapsible' in formatted:
        formatted['feynman_explanation_collapsible'] = prettify_html(formatted['feynman_explanation_collapsible'])
    
    if 'concept_explanation_collapsible' in formatted:
        formatted['concept_explanation_collapsible'] = prettify_html(formatted['concept_explanation_collapsible'])
