...
from agent_actions.utils.limits import MAX_RECORDS_KEY, NO_RECORD_CAP_KEY
...
def load_workflow_configs(
    ...
    for action_name, action_config in action_configs.items():
        ...
        if config.max_records is not None:
            action_config[MAX_RECORDS_KEY] = config.max_records
        if config.no_record_cap:
            action_config[NO_RECORD_CAP_KEY] = True
