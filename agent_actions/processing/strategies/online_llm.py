...
class OnlineLLMStrategy:
    ...
    def process_record(
        ...
        # Uses direct injection (not carry_framework_fields) because
        # prepared.target_id may not exist on input_record for first-stage
        # actions where the ID is generated by TaskPreparer.prepare().
