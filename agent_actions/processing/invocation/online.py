"""Online (synchronous) invocation strategy with retry and expectation recovery."""
...
class OnlineStrategy(InvocationStrategy):
    """Synchronous LLM invocation with retry and expectation recovery."""
    ...
    def invoke(
        ...
        """Execute LLM synchronously with optional retry and expectation recovery."""
    ...
    def supports_recovery(self) -> bool:
        """OnlineStrategy supports retry and expectation recovery."""
        return True
