...
| `parser.py` | Module | `WhereClauseParser`, `ParseResult`, `SafeExpressionEvaluator`, and convenience helpers that build ASTs from WHERE clauses with caching, validation, and modern pyparsing APIs. | `filtering`, `configuration`, `validation` |
