...
class ExecutionTiming:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {'name': self.name, 'started_at': self.started_at, 'completed_at': self.completed_at}
...
class AgentResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {'unique_id': self.unique_id, 'status': self.status, 'timing': [t.to_dict() for t in self.timing], 'thread_id': self.thread_id, 'execution_time': self.execution_time, 'message': self.message, 'failures': self.failures, 'adapter_response': self.adapter_response, 'error_details': self.error_details}
...
class RunResultsArtifact(BaseArtifact):
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {'metadata': self.metadata.to_dict(), 'elapsed_time': self.elapsed_time, 'args': self.args, 'results': [r.to_dict() for r in self.results]}
