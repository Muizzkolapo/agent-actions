...
class DocsCommandArgs(BaseModel):
    ...
    host: str = Field("0.0.0.0", description="Host for the documentation server.")
    ...
    open_browser: bool = Field(True, description="Open the browser automatically when the server starts.")
