...
| `VersionIdGenerator` | Class | Thread-safe registry with helper methods like `get_or_create_version_correlation_id`, `_generate_deterministic_correlation_id`, and payload helpers for object augmentation. | `lineage`, `logging` |
