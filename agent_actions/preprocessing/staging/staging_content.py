...
class StagingContentLoader:
    ...
    async def _process_tabular_content_async(self, content, _agent_config=None, _agent_name=None):
    ...
    async def _process_xml_content_async(self, content, _agent_config=None, _agent_name=None):
