...
class DataProcessor(ProcessorErrorHandlerMixin, IDataProcessor):
    ...
    def process_item(self, contents: Dict, generated_data: List[Dict], source_guid: str, idx: int=0, passthrough_fields: Optional[Dict]=None) -> List[Dict]:
        """
        ...
        """
        try:
            return transform_with_passthrough(generated_data, contents, source_guid, self.agent_config, idx, passthrough_fields=passthrough_fields)
