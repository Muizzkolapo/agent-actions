...
class RepromptInterceptor(ResponseInterceptor):
    ...
    def configure(self, config: Dict) -> None:
        ...
        if strategy_type == 'llm':
            ...
            simple_config = {'include_previous_response': config.get('include_previous_response', True), 'prompt_debug': self.prompt_debug}
    ...
    def intercept(self, response: Any, context: Dict) -> InterceptorResult:
        ...
        if attempt >= self.max_attempts:
            ...
            return InterceptorResult(continue_processing=False, metadata={'max_attempts_reached': True})
