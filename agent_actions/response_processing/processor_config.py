...
class ProcessorConfig(BaseModel):
    ...
    enabled: bool = Field(
        default=True, description='Whether processor is enabled'
    )
    ...
    timeout: int = Field(
        default=300, ge=1, description='Processing timeout in seconds'
    )
...
class CacheConfig(BaseModel):
    ...
    key_prefix: str = Field(
        default='processor', description='Prefix for cache keys'
    )
...
class DataProcessorConfig(ProcessorConfig):
    ...
    transformation_enabled: bool = Field(
        default=True, description='Enable data transformations'
    )
...
class GeneratorConfig(ProcessorConfig):
    ...
    dynamic_agent_enabled: bool = Field(
        default=True, description='Enable dynamic agent creation'
    )
...
class ContentProcessorConfig(ProcessorConfig):
    ...
    error_handling_strategy: Literal[
        'fail_fast', 'skip_errors', 'collect_errors'
    ] = Field(
