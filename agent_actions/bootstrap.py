...
from .core.startup_validator import validate_startup, StartupValidationError
...
def initialize_application(constructor_path: Optional[str] = None, 
                         default_path: Optional[str] = None,
                         skip_validation: bool = False) -> EnvironmentConfig:
    """
...
def create_agent_runner(config: Optional[Dict[str, Any]] = None, 
    ...
    """
    with application_container_context(config, validate_startup_config=True, 
                                     constructor_path=constructor_path, 
                                     default_path=default_path) as container:
