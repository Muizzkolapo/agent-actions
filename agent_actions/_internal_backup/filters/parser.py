...
class WhereClauseParser:
    ...
    def _build_grammar(self):
        ...
        array_literal = (LBRACKET + 
                        PyOptional(array_element + ZeroOrMore(COMMA + array_element)) + 
                        RBRACKET)
    ...
    def _validate_field_names(self, where_clause: str) -> bool:
        ...
        tokens = re.split(r'[=!<>]|\b(?:and|or|not|in|like|between|is|null|contains)\b', where_clause, flags=re.IGNORECASE)
    ...
    def get_cache_info(self) -> Dict[str, Any]:
        ...
        cache_info = self.parse_cached.cache_info()
        return {
