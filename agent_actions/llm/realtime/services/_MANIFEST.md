...
| `invocation.py` | Module | Dispatches realtime provider invocations across LLM/tool/HITL clients, including lazy provider resolution for optional/deprecated SDKs. | `llm.providers`, `workflow` |
