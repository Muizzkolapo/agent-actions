...
class OutputHandler:
    ...
    def save_main_output(self, data, file_path, base_directory, output_directory):
        ...
        try:
            ...
            raise AgentActionsException('IOError saving main output', context={'output_file_path': str(output_file_path), 'file_path': file_path, 'operation': 'save_main_output'}, cause=e)
        except Exception as e:
            raise AgentActionsException('Error saving main output', context={'output_file_path': str(output_file_path), 'file_path': file_path, 'operation': 'save_main_output'}, cause=e)
    ...
    def save_side_output(self, data, file_path, base_directory, output_directory):
        ...
        try:
            ...
            raise AgentActionsException('IOError saving side output', context={'side_output_file_path': str(side_output_file_path), 'file_path': file_path, 'operation': 'save_side_output'}, cause=e)
        except Exception as e:
            raise AgentActionsException('Error saving side output', context={'side_output_file_path': str(side_output_file_path), 'file_path': file_path, 'operation': 'save_side_output'}, cause=e)
