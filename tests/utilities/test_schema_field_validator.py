...
import pytest
from agent_actions.utilities.field_resolution.schema_field_validator import (
...
class TestSchemaFieldValidator:
    ...
    def test_type_extraction(self):
        ...
        for field_name, expected_type in types_to_test:
            ...
            assert result.exists
            assert result.field_type == expected_type, f"Expected {expected_type}, got {result.field_type}"
