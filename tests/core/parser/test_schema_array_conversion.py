...
import pytest
import logging
from agent_actions.response_processing.schema_change import compile_unified_schema, _convert_json_schema_to_unified
...
class TestArraySchemaConversion:
    ...
    def test_array_schema_with_empty_items(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger='agent_actions.response_processing.schema_change'):
            result = compile_unified_schema(schema, 'anthropic')
    ...
    def test_array_schema_with_description(self):
        ...
        assert result[0]['description'] == 'List of items', \
        ...
        for vendor in vendors:
            ...
            if vendor == 'anthropic':
                ...
                assert result[0]['input_schema']['properties'], \
                    f"{vendor} should have properties"
            elif vendor == 'openai':
    ...
    def test_array_schema_with_item_constraints(self):
        ...
        items_props = result[0]['input_schema']['properties']['validated_items']['items']['properties']
