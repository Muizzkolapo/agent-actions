...
class TestMultiBatchCorrelationConsistency:
    ...
    def test_same_session_produces_identical_correlation_ids(self):
        ...
        id1 = LoopIdGenerator.get_or_create_loop_correlation_id(
            source_guid, loop_base_name, session_id
        )
        LoopIdGenerator.clear_loop_correlation_registry()
        id2 = LoopIdGenerator.get_or_create_loop_correlation_id(
            source_guid, loop_base_name, session_id
        )
    ...
    def test_workflow_session_id_isolation(self):
        ...
        id3 = LoopIdGenerator.get_or_create_loop_correlation_id(
            source_guid, loop_base_name, workflow_1_session
        )
    ...
    def test_add_loop_correlation_id_with_workflow_session(self):
        ...
        print(
            f"✅ add_loop_correlation_id produces deterministic results: {result1['loop_correlation_id']}"
        )
