...
class TestMultiBatchCorrelationConsistency:
    ...
    def test_same_session_produces_identical_correlation_ids(self):
        ...
        id1 = ProcessorUtils.get_or_create_loop_correlation_id(source_guid, loop_base_name, session_id)
        ProcessorUtils.clear_loop_correlation_registry()
        id2 = ProcessorUtils.get_or_create_loop_correlation_id(source_guid, loop_base_name, session_id)
    ...
    def test_different_sessions_produce_different_correlation_ids(self):
        ...
        source_guid = 'record-123'
        loop_base_name = 'generate_distractors'
        id1 = ProcessorUtils.get_or_create_loop_correlation_id(source_guid, loop_base_name, 'session_1')
        id2 = ProcessorUtils.get_or_create_loop_correlation_id(source_guid, loop_base_name, 'session_2')
    ...
    def test_multi_batch_session_simulation(self):
        ...
        source_records = [{'source_guid': 'record-1', 'content': 'data-1'}, {'source_guid': 'record-2', 'content': 'data-2'}, {'source_guid': 'record-3', 'content': 'data-3'}]
        loop_base_name = 'generate_distractors'
        batch_1_2_results = {}
        ...
        def simulate_batch_1_2():
            ...
            for record in source_records:
                ...
                correlation_id = ProcessorUtils.get_or_create_loop_correlation_id(source_guid, loop_base_name, shared_session_id)
        ...
        for record in source_records:
            ...
            assert batch_1_2_id == batch_3_id, f'Correlation ID mismatch for {source_guid}: Batch 1&2: {batch_1_2_id}, Batch 3: {batch_3_id}'
    ...
    def test_position_based_multi_batch_consistency(self):
        ...
        for position in positions:
            correlation_id = ProcessorUtils.get_or_create_position_based_loop_correlation_id(position, loop_base_name, shared_session_id, file_context)
        ...
        for position in positions:
            ...
            assert batch_1_id == batch_2_id, f'Position-based correlation ID mismatch for position {position}: Batch 1: {batch_1_id}, Batch 2: {batch_2_id}'
    ...
    def test_concurrent_multi_batch_scenario(self):
        ...
        for batch_id in range(1, num_batches):
            ...
            for source_guid in source_records:
                ...
                assert reference_id == batch_id_result, f'Correlation ID mismatch between batch 0 and batch {batch_id} for {source_guid}: {reference_id} vs {batch_id_result}'
    ...
    def test_workflow_session_id_isolation(self):
        ...
        id1 = ProcessorUtils.get_or_create_loop_correlation_id(source_guid, loop_base_name, workflow_1_session)
        workflow_2_session = 'workflow_2_session'
        id2 = ProcessorUtils.get_or_create_loop_correlation_id(source_guid, loop_base_name, workflow_2_session)
        id3 = ProcessorUtils.get_or_create_loop_correlation_id(source_guid, loop_base_name, workflow_1_session)
