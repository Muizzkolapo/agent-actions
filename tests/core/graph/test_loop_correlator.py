...
class TestLoopOutputCorrelator:
    ...
    def sample_execution_order(self):
        ...
        return ['extract_facts', 'generate_scenarios', 'generate_distractors_1', 'generate_distractors_2', 'generate_distractors_3', 'reconstruct_options', 'validate_quiz']

    @pytest.fixture
    def sample_agent_configs(self):
        """Provide sample agent configurations."""
        return {'extract_facts': {'agent_type': 'extract_facts', 'dependencies': []}, 'generate_scenarios': {'agent_type': 'generate_scenarios', 'dependencies': ['extract_facts']}, 'generate_distractors_1': {'agent_type': 'generate_distractors', 'dependencies': ['generate_scenarios']}, 'generate_distractors_2': {'agent_type': 'generate_distractors', 'dependencies': ['generate_scenarios']}, 'generate_distractors_3': {'agent_type': 'generate_distractors', 'dependencies': ['generate_scenarios']}, 'reconstruct_options': {'agent_type': 'reconstruct_options', 'dependencies': [], 'loop_consumption_config': {'source': 'generate_distractors', 'pattern': 'merge'}}, 'validate_quiz': {'agent_type': 'validate_quiz', 'dependencies': ['reconstruct_options']}}
    ...
    def test_detect_explicit_loop_consumption(self, correlator, sample_execution_order, sample_agent_configs):
        ...
        consumption_map = correlator.detect_explicit_loop_consumption(sample_execution_order, sample_agent_configs)
        ...
        assert set(config['loop_agents']) == {'generate_distractors_1', 'generate_distractors_2', 'generate_distractors_3'}
    ...
    def test_detect_explicit_loop_consumption_no_consumption(self, correlator):
        ...
        agent_configs = {'agent_a': {'dependencies': []}, 'agent_b': {'dependencies': ['agent_a']}, 'agent_c': {'dependencies': ['agent_b']}}
    ...
    def test_filename_preservation(self, correlator, temp_agent_folder):
        ...
        for i in range(1, 4):
            ...
            test_data = [{'source_guid': 'test-guid-1', 'loop_correlation_id': 'test-corr-1', 'target_id': 'target-1', 'content': {f'distractor_{i}': f'Wrong answer {i}'}}]
            with open(loop_dir / test_filename, 'w') as f:
                json.dump(test_data, f)
        result_dir = correlator.prepare_correlated_input('reconstruct_options', ['generate_distractors_1', 'generate_distractors_2', 'generate_distractors_3'], 4)
    ...
    def test_partial_record_handling(self, correlator, temp_agent_folder):
        ...
        data_loop1 = [{'source_guid': 'guid-1', 'loop_correlation_id': 'corr-1', 'content': {'field_1': 'value1'}}, {'source_guid': 'guid-2', 'loop_correlation_id': 'corr-2', 'content': {'field_1': 'value2'}}, {'source_guid': 'guid-3', 'loop_correlation_id': 'corr-3', 'content': {'field_1': 'value3'}}]
        data_loop2 = [{'source_guid': 'guid-1', 'loop_correlation_id': 'corr-1', 'content': {'field_2': 'value1'}}, {'source_guid': 'guid-2', 'loop_correlation_id': 'corr-2', 'content': {'field_2': 'value2'}}]
        data_loop3 = [{'source_guid': 'guid-1', 'loop_correlation_id': 'corr-1', 'content': {'field_3': 'value1'}}]
        ...
        result_dir = correlator.prepare_correlated_input('consumer', ['distractor_1', 'distractor_2', 'distractor_3'], 4)
    ...
    def test_multiple_file_correlation(self, correlator, temp_agent_folder):
        ...
        for filename in files:
            data1 = [{'source_guid': f'{filename}-guid-1', 'loop_correlation_id': f'{filename}-corr-1', 'content': {'loop1_data': f'data_from_{filename}'}}]
            with open(loop1_dir / filename, 'w') as f:
                json.dump(data1, f)
            data2 = [{'source_guid': f'{filename}-guid-1', 'loop_correlation_id': f'{filename}-corr-1', 'content': {'loop2_data': f'data_from_{filename}'}}]
            with open(loop2_dir / filename, 'w') as f:
                json.dump(data2, f)
        result_dir = correlator.prepare_correlated_input('aggregator', ['processor_1', 'processor_2'], 3)
        for filename in files:
    ...
    def test_correlate_by_source_record(self, correlator):
        ...
        loop_outputs = {'loop_1': [{'source_guid': 'guid-a', 'loop_correlation_id': 'corr-1', 'content': {'f1': 'v1'}}, {'source_guid': 'guid-b', 'loop_correlation_id': 'corr-2', 'content': {'f1': 'v2'}}], 'loop_2': [{'source_guid': 'guid-a', 'loop_correlation_id': 'corr-1', 'content': {'f2': 'v3'}}, {'source_guid': 'guid-b', 'loop_correlation_id': 'corr-2', 'content': {'f2': 'v4'}}], 'loop_3': [{'source_guid': 'guid-a', 'loop_correlation_id': 'corr-1', 'content': {'f3': 'v5'}}]}
    ...
    def test_write_correlated_data(self, correlator, temp_agent_folder):
        ...
        test_data = [{'source_guid': 'g1', 'content': {'field': 'value'}}, {'source_guid': 'g2', 'content': {'field': 'value2'}}]
    ...
    def test_empty_loop_outputs(self, correlator, temp_agent_folder):
        ...
        result = correlator.prepare_correlated_input('consumer', ['nonexistent_1', 'nonexistent_2'], 5)
...
class TestLoopOutputCorrelatorIntegration:
    ...
    def mock_agent_workflow(self, tmp_path):
        ...
        workflow.agent_configs = {'extract': {'agent_type': 'extract'}, 'loop_1': {'agent_type': 'loop'}, 'loop_2': {'agent_type': 'loop'}, 'loop_3': {'agent_type': 'loop'}, 'consumer': {'agent_type': 'consumer', 'dependencies': ['loop']}}
    ...
    def test_integration_with_agent_workflow(self, mock_agent_workflow):
        ...
        for i in range(1, 4):
            ...
            loop_dir.mkdir(parents=True)
            data = [{'source_guid': 'test-guid', 'loop_correlation_id': 'test-corr', 'content': {f'field_{i}': f'value_{i}'}}]
...
class TestLoopCorrelatorWithSequentialMode:
    ...
    def test_sequential_loop_correlation_works(self, correlator, temp_agent_folder):
        ...
        for i in range(1, 4):
            ...
            loop_dir.mkdir(parents=True)
            test_data = [{'source_guid': f'test-{i}', 'loop_correlation_id': f'test-corr-{i}', 'content': {'iteration': i, 'data': f'refined_data_{i}'}}]
            with open(loop_dir / 'output.json', 'w') as f:
                json.dump(test_data, f)
        result_dir = correlator.prepare_correlated_input('aggregate', ['refine_1', 'refine_2', 'refine_3'], 4)
    ...
    def test_partial_sequential_failure_correlation(self, correlator, temp_agent_folder):
        ...
        for i in range(1, 3):
            ...
            loop_dir.mkdir(parents=True)
            test_data = [{'source_guid': 'test-guid', 'loop_correlation_id': 'test-corr', 'content': {f'field_{i}': f'value_{i}'}}]
            with open(loop_dir / 'result.json', 'w') as f:
                json.dump(test_data, f)
        result_dir = correlator.prepare_correlated_input('consumer', ['process_1', 'process_2', 'process_3'], 4)
        assert result_dir is not None
    ...
    def test_sequential_loop_with_mixed_metadata(self, correlator, temp_agent_folder):
        ...
        for i in range(1, 4):
            ...
            loop_dir.mkdir(parents=True)
            test_data = [{'source_guid': 'test-guid', 'loop_correlation_id': 'test-corr', 'loop_mode': 'sequential', 'loop_iteration': i, 'content': {'step': i, 'result': f'step_{i}_result'}}]
    ...
    def test_sequential_vs_parallel_correlation_same_behavior(self, correlator, temp_agent_folder):
        ...
        for i in range(1, 3):
            ...
            loop_dir.mkdir(parents=True)
            test_data = [{'source_guid': 'guid-1', 'loop_correlation_id': 'corr-1', 'loop_mode': 'sequential', 'content': {f'seq_field_{i}': f'seq_value_{i}'}}]
            with open(loop_dir / 'output.json', 'w') as f:
                json.dump(test_data, f)
        for i in range(3, 5):
            loop_dir = temp_agent_folder / 'target' / f'node_{i}_par_{i - 2}'
            loop_dir.mkdir(parents=True)
            test_data = [{'source_guid': 'guid-2', 'loop_correlation_id': 'corr-2', 'loop_mode': 'parallel', 'content': {f'par_field_{i - 2}': f'par_value_{i - 2}'}}]
            with open(loop_dir / 'output.json', 'w') as f:
                json.dump(test_data, f)
