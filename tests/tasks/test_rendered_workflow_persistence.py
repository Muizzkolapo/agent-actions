...
from agent_actions.prompt_generation.config_renderer import JinjaTemplateRenderer
...
class TestRenderedWorkflowPersistence:
    ...
    def test_rendered_workflow_saved_to_cache(self):
        ...
        with patch('agent_actions.tasks.services.config_renderer.render_pipeline_with_templates') as mock_render:
            ...
            result = renderer.render(config_path=str(config_file), template_dir=str(self.template_dir), output_path=str(self.output_dir))
    ...
    def test_rendered_workflow_not_saved_without_output_path(self):
        ...
        with patch('agent_actions.tasks.services.config_renderer.render_pipeline_with_templates') as mock_render:
            ...
            result = renderer.render(config_path=str(config_file), template_dir=str(self.template_dir), output_path=None)
    ...
    def test_multiple_workflows_rendered_to_same_directory(self):
        ...
        workflow_files = [('workflow1.yml', 'name: workflow1\nversion: 1.0'), ('workflow2.yml', 'name: workflow2\nversion: 2.0'), ('workflow3.yml', 'name: workflow3\nversion: 3.0')]
        renderer = JinjaTemplateRenderer()
        with patch('agent_actions.tasks.services.config_renderer.render_pipeline_with_templates') as mock_render:
            for filename, content in workflow_files:
                ...
                renderer.render(config_path=str(config_file), template_dir=str(self.template_dir), output_path=str(self.output_dir))
    ...
    def test_rendered_workflow_with_complex_path(self):
        ...
        with patch('agent_actions.tasks.services.config_renderer.render_pipeline_with_templates') as mock_render:
            ...
            renderer.render(config_path=str(config_file), template_dir=str(self.template_dir), output_path=str(nested_output))
