"""Tests for prepare_schema_unified explicit-schema-dropped warning."""
...
class TestPrepareSchemaUnifiedWarning:
    """prepare_schema_unified must warn when an explicit schema is silently dropped."""
    ...
    def test_warns_when_inline_schema_dropped(self, _load, _compile, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger=LOGGER_NAME):
            compiled, _ = prepare_schema_unified(agent_config, vendor="unknown_vendor")
    ...
    def test_no_warning_when_no_schema_configured(self, _compile, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger=LOGGER_NAME):
            compiled, _ = prepare_schema_unified(agent_config, vendor="openai")
    ...
    def test_no_warning_for_tool_vendor(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger=LOGGER_NAME):
            compiled, _ = prepare_schema_unified(agent_config, vendor="tool")
