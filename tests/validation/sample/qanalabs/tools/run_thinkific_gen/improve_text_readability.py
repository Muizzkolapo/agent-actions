...
@udf_tool(input_type=ImproveTextReadabilityInput)
def improve_text_readability(quiz_obj: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if "combined_explanation" in formatted:
        formatted["combined_explanation"] = improve_html_readability(
    ...
    if "feynman_explanation_collapsible" in formatted:
        formatted["feynman_explanation_collapsible"] = improve_html_readability(
            formatted["feynman_explanation_collapsible"]
        )

    if "concept_explanation_collapsible" in formatted:
        formatted["concept_explanation_collapsible"] = improve_html_readability(
