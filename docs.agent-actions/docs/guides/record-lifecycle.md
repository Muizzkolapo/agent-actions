...
```json
{
  ...
  "_state_schema_version": 1,
  "_state_history": [
    { "action": "classify_ticket", "from": null, "to": "processed", "reason": "success" },
    { "action": "classify_ticket", "from": "processed", "to": "active", "reason": "downstream_reset" },
    { "action": "extract_entities", "from": null, "to": "processed", "reason": "success" },
    { "action": "extract_entities", "from": "processed", "to": "active", "reason": "downstream_reset" },
    { "action": "search_kb", "from": null, "to": "processed", "reason": "success" },
    { "action": "search_kb", "from": "processed", "to": "active", "reason": "downstream_reset" },
    { "action": "draft_response", "from": null, "to": "processed", "reason": "success" },
    { "action": "draft_response", "from": "processed", "to": "active", "reason": "downstream_reset" },
    { "action": "review_response", "from": null, "to": "processed", "reason": "success" },
    { "action": "review_response", "from": "processed", "to": "active", "reason": "downstream_reset" },
    { "action": "route_decision", "from": null, "to": "processed", "reason": "success" },
    { "action": "route_decision", "from": "processed", "to": "active", "reason": "downstream_reset" },
    { "action": "send_response", "from": null, "to": "processed", "reason": "success" }
  ],
